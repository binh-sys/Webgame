...
<head>
  <meta charset="UTF-8">
  <meta name="description" content="Mẫu Web Tin Tức Game">
  <meta name="keywords" content="game, tin tức, esports, đánh giá, review">
 ...
 <!-- Footer -->
          ...
          <div class="footer-widget mb-5 mb-md-0">
            ...
            <div class="latest-blog">
              <div class="lb-item">
                <div class="lb-thumb set-bg" data-setbg="img/latest-blog/1.jpg"></div>
                <div class="lb-content">
                  <div class="lb-date">21/06/2025</div>
                  <p>Top game mobile được yêu thích nhất trong tháng.</p>
              ...
              <div class="lb-item">
                ...
                <div class="lb-content">
                  <div class="lb-date">21/06/2025</div>
                  <p>Những tựa game đáng mong chờ sắp ra mắt.</p>
                  <a href="#" class="lb-author">Bởi Admin</a>
                </div>
              </div>
              <div class="lb-item">
                ...
                <div class="lb-content">
                  <div class="lb-date">21/06/2025</div>
                  <p>Hướng dẫn cách tối ưu PC để chơi game mượt hơn.</p>
                  <a href="#" class="lb-author">Bởi Admin</a>
                </div>
              </div>
            </div>
          ...
          <div class="footer-widget">
            ...
            <div class="top-comment">
              <div class="tc-item">
                <div class="tc-thumb set-bg" data-setbg="img/authors/1.jpg"></div>
                <div class="tc-content">
                  <p><a href="#">Minh Hoàng</a> <span>bình luận về</span> game Liên Minh Huyền Thoại</p>
                  <div class="tc-date">21/06/2025</div>
                </div>
              </div>
              <div class="tc-item">
                <div class="tc-thumb set-bg" data-setbg="img/authors/2.jpg"></div>
                <div class="tc-content">
                  <p><a href="#">Tuấn Anh</a> <span>bình luận về</span> Valorant bản cập nhật mới</p>
                  <div class="tc-date">21/06/2025</div>
                </div>
              </div>
              <div class="tc-item">
                <div class="tc-thumb set-bg" data-setbg="img/authors/3.jpg"></div>
                <div class="tc-content">
                  <p><a href="#">Hoài Nam</a> <span>bình luận về</span> GTA VI trailer mới</p>
                  <div class="tc-date">21/06/2025</div>
                </div>
              </div>
              <div class="tc-item">
                ...
                <div class="tc-content">
                  <p><a href="#">Bảo Long</a> <span>bình luận về</span> Forza Horizon 6</p>
                  <div class="tc-date">21/06/2025</div>
                </div>
              </div>
            </div>
  ...
  <footer class="footer-section">
    <div class="container">
      ...
      <p class="copyright">
        Bản quyền &copy;<script>document.write(new Date().getFullYear());</script> | Thiết kế bởi <i class="fa fa-heart-o" aria-hidden="true"></i> <a href="https://colorlib.com" target="_blank">Colorlib</a>
      </p>
    </div>
  </footer>
